...
export const recibidaModernaDemo = {
  ...
  story: { eyebrow: "Lo logramos", title: "Un cierre y un comienzo", text: "Esta celebracion resume anos de estudio, apoyo y ganas. Magui quiere compartirla con quienes estuvieron cerca en el camino.", quote: "Todo esfuerzo merece un brindis a la altura." },
  ...
  gift: { enabled: true, text: "Tu compania es el mejor regalo. Si queres sumar a la celebracion, podes usar este alias.", alias: "magui.recibida", cbu: "" },
