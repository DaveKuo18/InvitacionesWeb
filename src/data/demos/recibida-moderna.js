...
export const recibidaModernaDemo = {
  ...
  title: "Sofi se recibe",
  eyebrow: "Recibida",
  dateISO: "2026-12-05T20:00:00-03:00",
  displayDate: "Sabado 5 de diciembre de 2026",
  ...
  story: { eyebrow: "Lo logramos", title: "Un cierre y un comienzo", text: "Esta celebracion resume anos de estudio, apoyo y ganas. Quiero compartirla con quienes estuvieron cerca en el camino.", quote: "Todo esfuerzo merece un brindis a la altura." },
  ...
  dressCode: { enabled: true, title: "Urbano elegante", note: "Veni comodo, con ganas de brindar y bailar." },
  gift: { enabled: true, text: "Tu compania es el mejor regalo. Si queres sumar a la celebracion, podes usar este alias.", alias: "sofi.recibida", cbu: "" },
  rsvp: { ...quinceGlamDemo.rsvp, mode: "form", deadline: "28 de noviembre de 2026", whatsappMessage: "Hola, confirmo mi asistencia a la recibida de Sofi. Mi nombre es:" },
};
